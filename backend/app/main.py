...
from app.pwned_passwords.router import router as pwned_passwords_router
...
def create_app(
    settings: Settings, *, catalog: BreachCatalogPort, pwned_passwords: PwnedPasswordRangePort
) -> FastAPI:
    ...
    app.state.pwned_passwords = pwned_passwords
